...
(function(factory) {
    ...
    defaults = {
        ...
        utilsScript: "",
        // set country name language, english by default
        language: "en"
    }, keys = {
        UP: 38,
        DOWN: 40,
   ...
   ********************/
        ...
        //Load language package
        _loadLanguagePackage: function() {
            var that = this,
            utilsScript;

            utilsScript = 'build/js/i18n/data.' + this.options.language +'.js';

            if (!$.fn[pluginName].loadedLanguagePackage && utilsScript) {
                // don't do this twice! (dont just check if the global intlTelInputUtils exists as if init plugin multiple times in quick succession, it may not have finished loading yet)
                $.fn[pluginName].loadedLanguagePackage = true;
                ...
                $.ajax({
                    ...
                    error: function() {
                      alert('Error to load '+ utilsScript + ' - File not found, check your language option');
                    },
                    dataType: "script",
                    cache: true
                });
